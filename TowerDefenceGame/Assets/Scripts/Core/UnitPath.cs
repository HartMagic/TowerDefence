...
namespace Core
{
    ...
    public sealed class UnitPath : MonoBehaviour
    {
        ...
        [SerializeField] private Vector3[] _controlPoints = new Vector3[]
        {
        ...
        [SerializeField] private ControlPointMode[] _controlPointModes = new ControlPointMode[]
        {
        ...
        private void EnforceMode(int index)
        {
            ...
            if (mode == ControlPointMode.Free ||
                !_isLoop && (modeIndex == 0 || modeIndex == _controlPointModes.Length - 1))
                return;
        ...
        public sealed class UnitPathMapper
        {
            ...
            public Vector3 MapPoint(float t)
            {
                ...
                return _path.GetPoint(
                    (index + (targetLength - lengthBefore) / (_path._arcLengths[index + 1] - lengthBefore)) /
